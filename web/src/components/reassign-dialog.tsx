...
export function ReassignDialog({
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // Create guest driver first if needed
      if (isCreatingGuest) {
  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 rounded-md bg-neutral-800 text-sm font-medium text-white hover:bg-neutral-700 transition-colors border border-neutral-700"
      >
        Reassign Driver
      </button>
